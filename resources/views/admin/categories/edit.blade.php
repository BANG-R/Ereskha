...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-2xl p-6 lg:p-8 border border-gray-100">
        <h3 class="font-outfit font-semibold text-xl text-gray-800 mb-6">Edit Kategori: {{ $category->name }}</h3>
        ...
        <form action="{{ route('admin.categories.update', $category) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                ...
                <textarea name="description" rows="3"
                          class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all @error('description') border-red-300 @enderror">{{ old('description', $category->description) }}</textarea>
            ...
            <div class="mb-6">
                ...
                @if($category->image)
                <div class="mb-3">
                    <img src="{{ $category->image_url }}" alt="{{ $category->name }}" class="w-32 h-32 object-cover rounded-xl">
