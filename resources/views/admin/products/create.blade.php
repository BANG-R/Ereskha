...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-2xl p-6 lg:p-8 border border-gray-100">
        <h3 class="font-outfit font-semibold text-xl text-gray-800 mb-6">Tambah Produk Baru</h3>
        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-2 gap-4 mb-5">
                <div>
                    ...
                    <input type="number" name="price" value="{{ old('price') }}" placeholder="0" step="1000"
                ...
                <div>
                    ...
                    <input type="number" name="discount_price" value="{{ old('discount_price') }}" placeholder="Opsional" step="1000"
